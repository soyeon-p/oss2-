...
def dataset_stat(dataset_df):	
	#To-Do: Implement this function
    feat = dataset_df[dataset_df.columns.difference(['target'])]
...
def random_forest_train_test(x_train, x_test, y_train, y_test):
    ...
    prec =(precision_score(y_test,rf_cls.predict(x_test),labels = None,pos_label = 1, average = 'binary',sample_weight = None,zero_division = 'warn'))
...
def svm_train_test(x_train, x_test, y_train, y_test):
    ...
    prec =(precision_score(y_test,svm_cls.predict(x_test),labels = None,pos_label = 1, average = 'binary',sample_weight = None,zero_division = 'warn'))
    recall = (recall_score (y_test,svm_cls.predict(x_test),labels = None,pos_label = 1, average = 'binary',sample_weight = None,zero_division = 'warn'))
    return acc,prec,recall
